...
\end{minipage}
\begin{minipage}[h]{0.5\linewidth}
\center{\includegraphics[width=1\linewidth]{SLIT6_our_star_photY} \\ фильтр Y (стандарт)}
\end{minipage}
\begin{minipage}[h]{0.5\linewidth}
...
\end{minipage}
\begin{minipage}[h]{0.5\linewidth}
\center{\includegraphics[width=1\linewidth]{y_hip85382-H-G-20180710233655-91_linearYcorr_spectr_abs} \\ фильтр H (стандарт)}
\end{minipage}
\begin{minipage}[h]{0.5\linewidth}
